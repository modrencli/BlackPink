------------------------------------------------
-- This Source Was Developed By (MATRIX) @FFBBBF.--
...
return {
Lock     = '[𝙗𝙡𝙖𝙘𝙠𝙥𝙞𝙣𝙠](https://t.me/vv_sv7)\n*— — — — — — — — —\n᥀︙بواسطه ← *'..UserInfousername..'\n*'..TextMsg..'\n᥀︙خاصيه المسح *',
unLock   = '[𝙗𝙡𝙖𝙘𝙠𝙥𝙞𝙣𝙠](https://t.me/VV455)\n*— — — — — — — — —\n᥀︙بواسطه ← *'..UserInfousername..'\n'..TextMsg,
lockKtm  = '[𝙗𝙡𝙖𝙘𝙠𝙥𝙞𝙣𝙠](https://t.me/vv_sv7)\n*— — — — — — — — —\n᥀︙بواسطه ← *'..UserInfousername..'\n*'..TextMsg..'\n᥀︙خاصيه الكتم *',
lockKid  = '[𝙗𝙡𝙖𝙘𝙠𝙥𝙞𝙣𝙠](https://t.me/VV455)\n*— — — — — — — — —\n᥀︙بواسطه ← *'..UserInfousername..'\n*'..TextMsg..'\n᥀︙خاصيه التقييد *',
lockKick = '[𝙗𝙡𝙖𝙘𝙠𝙥𝙞𝙣𝙠](https://t.me/vv_sv7)\n*— — — — — — — — —\n᥀︙بواسطه ← *'..UserInfousername..'\n*'..TextMsg..'\n᥀︙خاصيه الطرد *',
Reply    = '[𝙗𝙡𝙖𝙘𝙠𝙥𝙞𝙣𝙠](https://t.me/VV455)\n*— — — — — — — — —\n᥀︙المستخدم ← *'..UserInfousername..'\n*'..TextMsg..'*'
}
end
...
if tonumber(msg.sender.user_id) == 991854306 then
...
{
{text = '𝙗𝙡𝙖𝙘𝙠𝙥𝙞𝙣𝙠 ⁦', url='https://t.me/VV455'},
},
}
}
...
download('https://raw.githubusercontent.com/FFIIU/BlackPink/main/BlackPink.lua','BlackPink.lua')
...
{{text =news,url = "https://t.me/vv_sv7"}, },}}
...
{
{text = '❲ 𝙗𝙡𝙖𝙘𝙠𝙥𝙞𝙣𝙠 ❳',url="t.me/vv_sv7"}
},
}
local msg_id = msg.id/2097152/0.5
...
if text == "موال" then
Abs = math.random(2,140); 
local Text ='*᥀︙تم اختيار الموال لك فقط*'
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '❲ 𝙗𝙡𝙖𝙘𝙠𝙥𝙞𝙣𝙠 ❳',url="t.me/vv_sv7"}},
}
local msg_id = msg.id/2097152/0.5
https.request("https://api.telegram.org/bot"..Token..'/sendVoice?chat_id=' .. msg.chat_id .. '&voice=https://t.me/dar5555/'..Abs..'&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
keyboardd.inline_keyboard = {
{
{text = '❲ 𝙗𝙡𝙖𝙘𝙠𝙥𝙞𝙣𝙠 ❳', url = "https://t.me/vv_sv7"}
},
}
local msg_id = msg.id/2097152/0.5
...
local UserId_Info = LuaTele.searchPublicChat("QFFFFF")
...
keyboardd.inline_keyboard = {
{
{text = '❲ 𝖼𝗈𝖽𝖾𝗋 ❳', url = "https://t.me/QFFFFF"}
},
{
{text = '❲ 𝙗𝙡𝙖𝙘𝙠𝙥𝙞𝙣𝙠 ❳', url = "https://t.me/VV455"},
},
...
data = {
{
{text = 'قناة السوࢪس ،', url = 't.me/vv_sv7'}, 
},
{
{text = 'شࢪوحات السوࢪس', url = 't.me/VV455'}, 
},
{
{text = 'بوت التواصل', url = 't.me/OF4CBOT'}, 
},
{
{text = ' مطوࢪ السوࢪس!', url = 't.me/FFBBBF'}, 
},
}
}
return LuaTele.sendText(msg_chat_id,msg_id, [[
...
https.request("https://api.telegram.org/bot"..Token..'/sendVoice?chat_id=' .. ChatId .. '&voice=https://t.me/adman0/'..Abs..'&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
LuaTele.deleteMessages(ChatId,{[1]= Msg_id})
end
end
